...
public class URIPolicyTest {
    ...
    public void testPolicy() {
        ...
        Assert.assertEquals(AuthzDecision.ACCEPT, uriPolicy.isAuthorized(new AuthzRequestContext(john, request1)));
        ...
        Assert.assertEquals(AuthzDecision.REJECT, uriPolicy.isAuthorized(new AuthzRequestContext(evil, request1)));
        ...
        Assert.assertEquals(AuthzDecision.IGNORE, uriPolicy.isAuthorized(new AuthzRequestContext(john, request2)));
        Assert.assertEquals(AuthzDecision.REJECT, uriPolicy.isAuthorized(new AuthzRequestContext(evil, request2)));
        ...
        Assert.assertEquals(AuthzDecision.ACCEPT, uriPolicy.isAuthorized(new AuthzRequestContext(john, request3)));
        Assert.assertEquals(AuthzDecision.REJECT, uriPolicy.isAuthorized(new AuthzRequestContext(evil, request3)));
        ...
        Assert.assertEquals(AuthzDecision.IGNORE, uriPolicy.isAuthorized(new AuthzRequestContext(john, request4)));
        Assert.assertEquals(AuthzDecision.REJECT, uriPolicy.isAuthorized(new AuthzRequestContext(evil, request4)));
        ...
        Assert.assertEquals(AuthzDecision.ACCEPT, uriPolicy.isAuthorized(new AuthzRequestContext(john, request5)));
        Assert.assertEquals(AuthzDecision.REJECT, uriPolicy.isAuthorized(new AuthzRequestContext(evil, request5)));
        ...
        Assert.assertEquals(AuthzDecision.IGNORE, uriPolicy.isAuthorized(new AuthzRequestContext(john, request6)));
        Assert.assertEquals(AuthzDecision.REJECT, uriPolicy.isAuthorized(new AuthzRequestContext(evil, request6)));
        ...
        Assert.assertEquals(AuthzDecision.IGNORE, uriPolicy.isAuthorized(new AuthzRequestContext(john, request7)));
        Assert.assertEquals(AuthzDecision.REJECT, uriPolicy.isAuthorized(new AuthzRequestContext(evil, request7)));
        ...
        Assert.assertEquals(AuthzDecision.ACCEPT, uriPolicy.isAuthorized(new AuthzRequestContext(john, request8)));
        Assert.assertEquals(AuthzDecision.REJECT, uriPolicy.isAuthorized(new AuthzRequestContext(evil, request8)));
        ...
        Assert.assertEquals(AuthzDecision.IGNORE, uriPolicy.isAuthorized(new AuthzRequestContext(john, request9)));
        Assert.assertEquals(AuthzDecision.REJECT, uriPolicy.isAuthorized(new AuthzRequestContext(evil, request9)));
        ...
        Assert.assertEquals(AuthzDecision.ACCEPT, uriPolicy.isAuthorized(new AuthzRequestContext(john, request10)));
        Assert.assertEquals(AuthzDecision.REJECT, uriPolicy.isAuthorized(new AuthzRequestContext(evil, request10)));
        ...
        // Ignored.
        Assert.assertEquals(AuthzDecision.IGNORE, uriPolicy.isAuthorized(new AuthzRequestContext(john, request11)));
        Assert.assertEquals(AuthzDecision.REJECT, uriPolicy.isAuthorized(new AuthzRequestContext(evil, request11)));
        ...
        Assert.assertEquals(AuthzDecision.REJECT, uriPolicy.isAuthorized(new AuthzRequestContext(john, request12)));
        Assert.assertEquals(AuthzDecision.REJECT, uriPolicy.isAuthorized(new AuthzRequestContext(evil, request12)));
