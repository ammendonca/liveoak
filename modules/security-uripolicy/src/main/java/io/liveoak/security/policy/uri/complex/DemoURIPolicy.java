...
public class DemoURIPolicy extends URIPolicy {
    ...
    protected void doInit() {
        ...
        URIPolicyRule rule3 = URIPolicyRule.createEntry(9, "/droolsTest/*/bar/([abc].*)", "resourceParams().value(\"param1\") == $uriMatcher.group(1) && resourceParams().value(\"param2\") == $uriMatcher.group(2) && resourceParams().value(\"param3\") == $token.username",
                "*", null, null, null, null, "\"*\"", null);
        ...
        URIPolicyRule rule4 = URIPolicyRule.createEntry(10, "/droolsTest/{ $token.username }", null,
        ...
        URIPolicyRule rule5 = URIPolicyRule.createEntry(10, "/droolsTest/{ any($token.realmRoles) }", null,
                "*", null, null, null, null, "\"*\"", null);
